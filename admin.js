...
function generateCaption(event) {
  return `🎶 ${event.title}\n📍 ${event.city}, ${event.country}\n📅 ${formatDates(event.startDate, event.endDate)}\n\n${event.description}\n\nPreview generated by the independent Future IFCM concept prototype. #ChoralMusic #CreatorsTransformingTheWorld`;
}
...
form.addEventListener("submit", (event) => {
  ...
  document.querySelector(".form-status").textContent = "Event submitted. It is now waiting for prototype editorial approval.";
  updatePreview();
  renderQueue();
});
